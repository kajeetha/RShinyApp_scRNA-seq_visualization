...
#If the column is one of these like count or feature create the first UMAP, if its anything else creates the other UMAP. 
#If the column doesn’t exist just create a grey square that says column doesn’t exist. 
...
#If the gene is in the row names then create a feature plot and if it doesn’t exist there creates a grey blank screen that says gene doesn’t exist. 
